      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <section className="bg-white shadow-md rounded-lg p-8 md:p-12 lg:flex lg:items-center">
          ...
          <div className="lg:w-2/3 lg:pl-12 mt-8 lg:mt-0">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Her professional journey began in Tampa, Florida and has taken her to Los Angeles, California, where she continues to blend her passion for wine education and technology. Through Free the Cork, Krissy seeks to make personalized wine advice accessible and enjoyable for wine enthusiasts of all levels.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Krissy is dedicated to making wine knowledge accessible and enjoyable. She continually works to introduce new features, expanding educational resources and enhancing your personalized wine experience on Free the Cork.
            </p>
          </div>
        </section>
      </main>
